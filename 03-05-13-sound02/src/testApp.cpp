...
void testApp::update(){
    ...
    sinWave2.setFrequency( max(1,mouseX) );  // don't want to give a negative frequency...
...
void testApp::draw(){
    ...
    ofDrawBitmapStringHighlight("frequency:  " + ofToString(sinWave2.frequency), ofPoint(200,75));
...
void testApp::audioOut(float * output, int bufferSize, int nChannels){
	...
	for (int i = bufferSize/2; i < bufferSize; i++){
        ...
        float sample = sinWave2.getSample(); //ofRandom(-1,1);
